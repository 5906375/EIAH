...
const agentActionDefinitions = [
  { name: "aadv", description: aadvProfile.description, handler: aadvAgent, version: "v1" },
  { name: "defiOne", description: defiOneProfile.description, handler: defiOneAgent, version: "v1" },
  { name: "diarias", description: diariasProfile.description, handler: diariasAgent, version: "v1" },
  { name: "eiah", description: eiahProfile.description, handler: eiahAgent, version: "v1" },
  { name: "finNexus", description: finNexusProfile.description, handler: finNexusAgent, version: "v1" },
  {
  ...
  { name: "guardian", description: guardianProfile.description, handler: guardianAgent, version: "v1" },
  { name: "iBC", description: iBcProfile.description, handler: iBCAgent, version: "v1" },
  {
  ...
  { name: "j360", description: j360Profile.description, handler: j360Agent, version: "v1" },
  { name: "mkt", description: marketingProfile.description, handler: mktAgent, version: "v1" },
  { name: "nftPy", description: nftPyProfile.description, handler: nftPyAgent, version: "v1" },
  {
    name: "onchainMonitor",
  ...
  { name: "pitch", description: pitchProfileThinking.description, handler: pitchAgent, version: "v1" },
  {
    name: "riskAnalyzer",
