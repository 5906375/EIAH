...
export const eiahProfile: AgentProfileSeed = {
  ...
  chatCopy: {
    ...
    whatIDo: [
      ...
      "explico telas, blocos, tabelas, cards e colunas quando a dúvida é sobre a interface",
      "te ajudo a criar e acompanhar runs com menos atrito",
      "explico self-service, recipes, preview, produção, billing e bloqueios de enablement no workspace",
    ...
    exampleRequests: [
      ...
      "como funciona self-service e recipes?",
      "qual a diferenca entre simular, rodar agora e promover para producao?",
  ...
  modeContracts: [
    {
      ...
      chatCopy: {
        ...
        whatIDo: [
          ...
          "explico self-service, recipes, simulacao, producao e bloqueios de agente no workspace",
