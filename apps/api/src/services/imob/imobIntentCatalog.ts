...
export const IMOB_CONVERSATIONAL_INTENT_CATALOG: readonly ImobConversationalIntentDefinition[] = [
  ...
  {
    intentId: "workspace_case_list",
    coreIntent: "deal",
    primaryJourney: "negotiation",
    relatedJourneys: ["property_capture", "lead_qualification", "proposal", "visit_follow_up", "documentation", "contract", "closing", "temporada_rules"],
    businessGoal: "listar rapidamente os casos e códigos ativos do workspace atual",
    description: "Leitura resumida dos casos mais recentes do workspace com código, etapa e próximo movimento.",
    triggerPhrases: [
      "mostre me a lista dos codigos",
    ...
    responseFormat: {
      ...
      maxItems: 5,
      sections: ["priority", "commercial_read", "next_action"],
    },
    nextActionPolicy: "read_pipeline_status",
    quickReplies: ["Abrir caso", "Ver pendências", "Ver bloqueios", "Próximo passo"],
  },
  {
