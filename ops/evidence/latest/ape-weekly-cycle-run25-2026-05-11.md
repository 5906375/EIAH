# APE Weekly Cycle #25 — 2026-05-11
...
- rolloutMode: shadow
- canaryStage: pilot
- hardReasons: required_check_failed=check:e2e-recency, required_check_failed=check:backup-restore, required_check_failed=check:runbook-drill-recency
...
- check:runbook-drill-recency: FAIL
...
## Resultado
- Ciclo semanal executado com bloqueios em: required_check_failed=check:e2e-recency, required_check_failed=check:backup-restore, required_check_failed=check:runbook-drill-recency.
