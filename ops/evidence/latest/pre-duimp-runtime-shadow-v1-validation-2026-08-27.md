...
O diretório externo `/home/jusall/validation-pre-duimp-runtime-shadow-20260827-Utjpra/` contém os quatro logs e o manifest raw produzidos pela execução. As cópias preparadas em `ops/evidence/latest/` são byte a byte idênticas às origens.
